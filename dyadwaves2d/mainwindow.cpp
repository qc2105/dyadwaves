...
void MainWindow::conv2dfft(vector<double> &filt, int filt_ht, int filt_wd)
{
    ...
    fftw_plan plan_image, plan_image_red, plan_image_green, plan_image_blue, plan_filt, plan_ifft, plan_ifft_red, plan_ifft_green, plan_ifft_blue;
